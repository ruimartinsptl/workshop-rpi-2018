...
# images are NumPy arrays, stored as unsigned 8 bit integers -- this means
...
added = cv2.add(image, M)
cv2.imshow("QUIZ: Added", added)
(b, g, r) = added[152, 61]  # x=61, y=152 (as coordenadas estao trocadas)
print "Pixel at (152, 61) - Red: {r}, Green: {g}, Blue: {b}".format(r=r, g=g, b=b)
cv2.waitKey(0)
