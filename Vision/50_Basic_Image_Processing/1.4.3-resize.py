...
# QUIZ:
# Let's make our new image have a width of 100 pixels
r = 100.0 / image.shape[1]
dim = (100, int(image.shape[0] * r))
resized = cv2.resize(image, dim, interpolation=cv2.INTER_NEAREST)
(b, g, r) = resized[74, 20]  # x=20, y=74
...
for i in range(0, 2):
    ...
    (b, g, r) = resized[367, 170]  # x=170, y=367
    print "Pixel at (367, 170) - Red: {r}, Green: {g}, Blue: {b}".format(r=r, g=g, b=b)
cv2.imshow("Method: {}".format('quiz'), resized)
cv2.waitKey(0)
